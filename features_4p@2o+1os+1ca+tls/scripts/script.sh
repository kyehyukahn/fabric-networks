...
COUNTER=1
MAX_RETRY=5
ORDERER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tls-ca-example-com-7054.pem
...
setGlobals () {
	...
	if [ $1 -eq 0 -o $1 -eq 1 ] ; then
		...
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2/peers/peer2.org2/tls/ca.crt
